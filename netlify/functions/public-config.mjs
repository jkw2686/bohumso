export default async function handler() {
 ...
 return Response.json({enabled:true,url,key,naverLogin:process.env.NAVER_LOGIN_ENABLED==="true",visitMetrics:process.env.VISIT_METRICS_ENABLED==="true",operator:process.env.OPERATOR_NAME,contact:process.env.PRIVACY_CONTACT},{headers});
}
