...
export const states={requested:'요청',coordinating:'일정 조율',confirmed:'양측 확정 · 1차 미결제',scheduled:'미팅 예정',awaiting_completion:'완료 확인 대기',completed:'완료',cancelled:'취소',no_show:'노쇼 신고',dispute:'분쟁',unmatched:'매칭실패 · 전문가 모집 중'};
