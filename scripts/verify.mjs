...
const commands=[['Production build',['scripts/build.mjs']],['Database and gateway tests',['--test','--test-concurrency=1',...suites]],['Signup regression',['tests/browser-smoke.cjs']],['Brand and consent mobile',['tests/brand-browser.cjs']],['Mobile/desktop end-to-end',['tests/commerce-browser.cjs']]];
